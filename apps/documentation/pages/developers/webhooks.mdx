...
| `payload.type`                               | string    | The type of the document.                             |
| `payload.distributionMethod`                 | string    | How the document is distributed.                      |
| `payload.language`                           | string    | The language of the document.                         |
| `payload.recipients`                         | array     | List of recipients and their details.                 |
...
| `payload.recipients[].role`                  | string    | The role of the recipient (e.g., SIGNER).             |
| `payload.recipients[].readStatus`            | string    | Whether the recipient has opened the document.        |
| `payload.recipients[].signingStatus`         | string    | Whether the recipient has signed the document.        |
| `payload.recipients[].sendStatus`            | string    | Status of the signature request email.                |
...
| `payload.recipients[].fields[].type`         | string    | The type of the field (e.g., SIGNATURE).              |
| `payload.recipients[].fields[].value`        | string?   | The value of the field if filled.                     |
