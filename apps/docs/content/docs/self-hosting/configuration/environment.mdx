...
These variables require an active [Enterprise Edition](/docs/policies/enterprise-edition) license. Obtain a license key from [license.davincisolutions.ai](https://license.davincisolutions.ai) and set it below to unlock enterprise features such as SSO, embed editor, and 21 CFR Part 11 compliance.
