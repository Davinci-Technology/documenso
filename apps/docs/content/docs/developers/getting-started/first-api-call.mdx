...
<Tab value="curl">
```bash
curl -X POST "https://app.davincisolutions.ai/api/v2/envelope/envelope_abc123/distribute" \
  -H "Authorization: YOUR_API_TOKEN" \
...
const response = await fetch(
  `https://app.davincisolutions.ai/api/v2/envelope/${envelopeId}/distribute`,
  {
    method: 'POST',
    headers: {
      Authorization: 'YOUR_API_TOKEN',
...
BASE_URL="https://app.davincisolutions.ai/api/v2"
...
- [API Reference](https://openapi.davincisolutions.ai/) - Full endpoint documentation with request/response schemas
