...
curl -X GET "https://app.davincisolutions.ai/api/v2/envelope?status=PENDING&page=1&perPage=20" \
 -H "Authorization: api_xxxxxxxxxxxxxxxx"
...
const BASE_URL = 'https://app.davincisolutions.ai/api/v2';
...
<Tab value="curl">
```bash
curl -X GET "https://app.davincisolutions.ai/api/v2/envelope/envelope_abc123" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx"
```
</Tab>
<Tab value="TypeScript">
...
const response = await fetch(`https://app.davincisolutions.ai/api/v2/envelope/${envelopeId}`, {
  method: 'GET',
  headers: {
...
<Tab value="curl">
```bash
curl -X POST "https://app.davincisolutions.ai/api/v2/envelope/update" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
...
<Tab value="TypeScript">
```typescript
const response = await fetch('https://app.davincisolutions.ai/api/v2/envelope/update', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
  ...
  "recipients": [
    {
      ...
      "role": "SIGNER",
      "signingOrder": 1,
      "signingUrl": "https://app.davincisolutions.ai/sign/abc123xyz"
    }
  ]
}
````
...
<Tab value="curl">
```bash
curl -X POST "https://app.davincisolutions.ai/api/v2/envelope/cancel" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "envelopeId": "envelope_abc123",
...
<Tab value="TypeScript">
```typescript
const response = await fetch('https://app.davincisolutions.ai/api/v2/envelope/cancel', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
    'Content-Type': 'application/json',
...
<Tab value="curl">
```bash
curl -X POST "https://app.davincisolutions.ai/api/v2/envelope/delete" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "envelopeId": "envelope_abc123"
...
<Tab value="TypeScript">
```typescript
const response = await fetch('https://app.davincisolutions.ai/api/v2/envelope/delete', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
    'Content-Type': 'application/json',
...
<Tab value="curl">
```bash
curl -X POST "https://app.davincisolutions.ai/api/v2/envelope/get-many" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "ids": {
...
const response = await fetch('https://app.davincisolutions.ai/api/v2/envelope/get-many', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
    'Content-Type': 'application/json',
...
async function getAllPendingDocuments() {
  ...
  while (hasMore) {
    const response = await fetch(
      `https://app.davincisolutions.ai/api/v2/envelope?status=PENDING&page=${page}&perPage=100`,
      {
