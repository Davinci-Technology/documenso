...
export const deleteAttachmentRoute = authenticatedProcedure
  .meta({
    openapi: {
      ...
      description:
        'Deprecated: this endpoint is being replaced by the Envelope API. See https://docs.davincisolutions.ai/docs/developers/api/migrate-to-envelopes for the migration guide. Delete an attachment from a document',
      tags: ['Document'],
      deprecated: true,
    },
  })
