  ...
  getDocumentField: authenticatedProcedure
    .meta({
      openapi: {
        ...
        description:
          'Deprecated: this endpoint is being replaced by the Envelope API. See https://docs.davincisolutions.ai/docs/developers/api/migrate-to-envelopes for the migration guide. Returns a single field. If you want to retrieve all the fields for a document, use the "Get Document" endpoint.',
  ...
  createDocumentField: authenticatedProcedure
    .meta({
      openapi: {
        ...
        description:
          'Deprecated: this endpoint is being replaced by the Envelope API. See https://docs.davincisolutions.ai/docs/developers/api/migrate-to-envelopes for the migration guide. Create a single field for a document.',
        tags: ['Document Fields'],
        deprecated: true,
      },
    })
  ...
  createDocumentFields: authenticatedProcedure
    .meta({
      openapi: {
        ...
        description:
          'Deprecated: this endpoint is being replaced by the Envelope API. See https://docs.davincisolutions.ai/docs/developers/api/migrate-to-envelopes for the migration guide. Create multiple fields for a document.',
        tags: ['Document Fields'],
        deprecated: true,
      },
    })
  ...
  updateDocumentField: authenticatedProcedure
    .meta({
      openapi: {
        ...
        description:
          'Deprecated: this endpoint is being replaced by the Envelope API. See https://docs.davincisolutions.ai/docs/developers/api/migrate-to-envelopes for the migration guide. Update a single field for a document.',
        tags: ['Document Fields'],
        deprecated: true,
      },
    })
  ...
  updateDocumentFields: authenticatedProcedure
    .meta({
      openapi: {
        ...
        description:
          'Deprecated: this endpoint is being replaced by the Envelope API. See https://docs.davincisolutions.ai/docs/developers/api/migrate-to-envelopes for the migration guide. Update multiple fields for a document.',
        tags: ['Document Fields'],
        deprecated: true,
      },
    })
  ...
  createTemplateField: authenticatedProcedure
    .meta({
      openapi: {
        ...
        description:
          'Deprecated: this endpoint is being replaced by the Envelope API. See https://docs.davincisolutions.ai/docs/developers/api/migrate-to-envelopes for the migration guide. Create a single field for a template.',
  ...
  getTemplateField: authenticatedProcedure
    .meta({
      openapi: {
        ...
        description:
          'Deprecated: this endpoint is being replaced by the Envelope API. See https://docs.davincisolutions.ai/docs/developers/api/migrate-to-envelopes for the migration guide. Returns a single field. If you want to retrieve all the fields for a template, use the "Get Template" endpoint.',
        tags: ['Template Fields'],
        deprecated: true,
      },
    })
  ...
  createTemplateFields: authenticatedProcedure
    .meta({
      openapi: {
        ...
        description:
          'Deprecated: this endpoint is being replaced by the Envelope API. See https://docs.davincisolutions.ai/docs/developers/api/migrate-to-envelopes for the migration guide. Create multiple fields for a template.',
        tags: ['Template Fields'],
        deprecated: true,
      },
    })
  ...
  updateTemplateField: authenticatedProcedure
    .meta({
      openapi: {
        ...
        description:
          'Deprecated: this endpoint is being replaced by the Envelope API. See https://docs.davincisolutions.ai/docs/developers/api/migrate-to-envelopes for the migration guide. Update a single field for a template.',
        tags: ['Template Fields'],
        deprecated: true,
      },
    })
  ...
  updateTemplateFields: authenticatedProcedure
    .meta({
      openapi: {
        ...
        description:
          'Deprecated: this endpoint is being replaced by the Envelope API. See https://docs.davincisolutions.ai/docs/developers/api/migrate-to-envelopes for the migration guide. Update multiple fields for a template.',
        tags: ['Template Fields'],
        deprecated: true,
      },
    })
